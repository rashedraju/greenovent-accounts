...
<form action="{{ route('accounts.expenses.investment.update', $expense) }}" method="post">
    @csrf
    @method('put')
    ...
    <input type="text" class="form-control" name="company_name" value="{{ $expense->company_name }}">
