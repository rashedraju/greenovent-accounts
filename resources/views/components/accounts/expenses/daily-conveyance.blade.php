@props(['heads', 'expenses', 'employees', 'transactionTypes'])
        ...
        <tbody>
            @foreach ($expenses as $expense)
                ...
                <x-drawer btnId="edit_daily_conveyance_drawer_btn_{{ $loop->iteration }}"
                    ...
                    <x-forms.accounts.expenses.edit-daily-conveyance :heads="$heads" :expense="$expense" :employees="$employees"
                ...
                <x-drawer btnId="delete_daily_conveyance_drawer_btn_{{ $loop->iteration }}"
                    ...
                    <form method="post" action="{{ route('accounts.expenses.daily-conveyance.delete', $expense) }}">
                        @csrf
                        @method('delete')
