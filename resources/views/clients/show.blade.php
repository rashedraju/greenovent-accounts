                                ...
                                <div class="d-flex gap-2 mt-6">
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                        <div class="fs-4 fw-bolder text-gray-700 text-center">
                                            <span
                                                class="w-75px">{{ number_format($client->totalSales()) }}</span>
                                        </div>
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                        <div class="fs-4 fw-bolder text-gray-700 text-center">
                                            <span
                                                class="w-75px">{{ number_format($client->salesThisYear()) }}</span>
                                        </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                                            ...
                                            <table class="table align-middle table-row-dashed gy-5 dataTable no-footer"
                                                ...
                                                <thead class="border-bottom border-gray-200 fs-7 fw-bolder">
                                                    ...
                                                    <tr class="text-start text-muted text-uppercase gs-0">
                                                        <th class="min-w-100px sorting" tabindex="0"
                                                            ...
                                                            style="width: 137.953px;">Invoice No.</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="kt_table_customers_payment" rowspan="1"
                                                            colspan="1"
                                                            aria-label="Status: activate to sort column ascending"
                                                            style="width: 126.375px;">Status</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="kt_table_customers_payment" rowspan="1"
                                                            colspan="1"
                                                            aria-label="Amount: activate to sort column ascending"
                                                            style="width: 112.703px;">Amount</th>
                                                        <th class="min-w-100px sorting" tabindex="0"
                                                            aria-controls="kt_table_customers_payment" rowspan="1"
                                                            colspan="1"
                                                            aria-label="Date: activate to sort column ascending"
                                                            style="width: 227.078px;">Date</th>
                                                        <th class="text-end min-w-100px pe-4 sorting_disabled"
                                                            rowspan="1" colspan="1" aria-label="Actions"
                                                            style="width: 146.641px;">Actions</th>
                                                    </tr>
                                                    <!--end::Table row-->
                                                </thead>
                                                <!--end::Table head-->
                                                ...
                                                <tbody class="fs-6 fw-bold text-gray-600">
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <a href="#"
                                                                class="text-gray-600 text-hover-primary mb-1">7564-7080</a>
                                                        </td>
                                                        <!--end::Invoice=-->
                                                        <!--begin::Status=-->
                                                        <td>
                                                        ...
                                                        <!--end::Amount=-->
                                                        <!--begin::Date=-->
                                                        <td data-order="2020-12-14T20:43:00+06:00">14 Dec 2020, 8:43 pm
                                                        </td>
                                                        <!--end::Date=-->
                                                        <!--begin::Action=-->
                                                    ...
                                                    <tr class="even">
                                                        ...
                                                        <td>
                                                            <a href="#"
                                                                class="text-gray-600 text-hover-primary mb-1">5301-1570</a>
                                                        </td>
                                                        <!--end::Invoice=-->
                                                        <!--begin::Status=-->
                                                        <td>
                                                        ...
                                                        <!--end::Amount=-->
                                                        <!--begin::Date=-->
                                                        <td data-order="2020-12-01T10:12:00+06:00">01 Dec 2020, 10:12 am
                                                        </td>
                                                        <!--end::Date=-->
                                                        <!--begin::Action=-->
                                                        <td class="pe-0 text-end">
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <a href="#"
                                                                class="text-gray-600 text-hover-primary mb-1">4110-2436</a>
                                                        </td>
                                                        <!--end::Invoice=-->
                                                        <!--begin::Status=-->
                                                        <td>
                                                        ...
                                                        <!--end::Amount=-->
                                                        <!--begin::Date=-->
                                                        <td data-order="2020-11-12T14:01:00+06:00">12 Nov 2020, 2:01 pm
                                                        </td>
                                                        <!--end::Date=-->
                                                        <!--begin::Action=-->
                                                        <td class="pe-0 text-end">
                                                    ...
                                                    <tr class="even">
                                                        ...
                                                        <td>
                                                            <a href="#"
                                                                class="text-gray-600 text-hover-primary mb-1">1252-6501</a>
                                                        </td>
                                                        <!--end::Invoice=-->
                                                        <!--begin::Status=-->
                                                        <td>
                                                        ...
                                                        <!--end::Amount=-->
                                                        <!--begin::Date=-->
                                                        <td data-order="2020-10-21T17:54:00+06:00">21 Oct 2020, 5:54 pm
                                                        </td>
                                                        <!--end::Date=-->
                                                        <!--begin::Action=-->
                                                        <td class="pe-0 text-end">
                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <a href="#"
                                                                class="text-gray-600 text-hover-primary mb-1">5369-6485</a>
                                                        </td>
                                                        <!--end::Invoice=-->
                                                        <!--begin::Status=-->
                                                        <td>
                                                        ...
                                                        <!--end::Amount=-->
                                                        <!--begin::Date=-->
                                                        <td data-order="2020-10-19T07:32:00+06:00">19 Oct 2020, 7:32 am
                                                        </td>
                                                        <!--end::Date=-->
                                                        <!--begin::Action=-->
                                                        <td class="pe-0 text-end">
                                            ...
                                            <div class="d-flex align-items-center collapsible rotate"
                                                ...
                                                <div class="me-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="text-gray-800 fw-bolder">Mastercard
                                                        </div>
                                                    ...
                                                    <table class="table table-flush fw-bold gy-1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Number</td>
                                                                <td class="text-gray-800">**** 8538</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Expires</td>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Type</td>
                                                                <td class="text-gray-800">Mastercard credit
                                                                    card</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    ID</td>
                                                                <td class="text-gray-800">id_4325df90sdf8
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table class="table table-flush fw-bold gy-1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Phone</td>
                                                                <td class="text-gray-800">No phone provided
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                    ...
                                                    <table class="table table-flush fw-bold gy-1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Number</td>
                                                                <td class="text-gray-800">**** 9083</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Expires</td>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Type</td>
                                                                <td class="text-gray-800">Visa credit card
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="py-3 d-flex flex-stack flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center collapsible collapsed rotate"
                                                ...
                                                <div class="me-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="text-gray-800 fw-bolder">American
                                                            Express</div>
                                                    ...
                                                    <table class="table table-flush fw-bold gy-1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Number</td>
                                                                <td class="text-gray-800">**** 2542</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Expires</td>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Type</td>
                                                                <td class="text-gray-800">American express
                                                                    credit card</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                    ...
                                                    <table class="table table-flush fw-bold gy-1">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">
                                                                    Origin</td>
                                                                <td class="text-gray-800">United States of
                                                                    America
                                                                    <div class="symbol symbol-20px symbol-circle ms-2">
                                                                        <img
                            ...
                            <div class="card pt-4 mb-6 mb-xl-9">
                                ...
                                <div class="card-body pt-0">
                                    <div class="fw-bolder fs-2">$32,487.57
                                        ...
                                        <div class="fs-7 fw-normal text-muted">Balance will increase the
                                            amount due on the customer's next invoice.</div>
                                    </div>
                                </div>
                                <!--end::Card body-->
                            </div>
                                                        ...
                                                        <thead
                                                            ...
                                                            <tr class="text-start text-muted gs-0">
                                                                <th class="min-w-100px sorting" tabindex="0"
                                                                    ...
                                                                    style="width: 136.812px;">Order ID</th>
                                                                <th class="min-w-100px sorting" tabindex="0"
                                                                    aria-controls="kt_customer_details_invoices_table_1"
                                                                    rowspan="1" colspan="1"
                                                                    aria-label="Amount: activate to sort column ascending"
                                                                    style="width: 140.391px;">Amount</th>
                                                                <th class="min-w-100px sorting" tabindex="0"
                                                                    aria-controls="kt_customer_details_invoices_table_1"
                                                                    rowspan="1" colspan="1"
                                                                    aria-label="Status: activate to sort column ascending"
                                                                    style="width: 140.391px;">Status</th>
                                                                <th class="min-w-125px sorting" tabindex="0"
                                                                    aria-controls="kt_customer_details_invoices_table_1"
                                                                    rowspan="1" colspan="1"
                                                                    aria-label="Date: activate to sort column ascending"
                                                                    style="width: 174.594px;">Date</th>
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <!--begin::Badge=-->
                                                    <td class="min-w-70px">
                                                        <div class="badge badge-light-danger">500 ERR
                                                        </div>
                                                    </td>
                                                    <!--end::Badge=-->
                                                    <!--begin::Status=-->
                                                    <td>POST /v1/invoice/in_2175_7750/invalid</td>
                                                    <!--end::Status=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-end min-w-200px">21 Feb 2022,
                                                        11:05 am</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Badge=-->
                                                    <!--begin::Status=-->
                                                    <td>POST /v1/invoices/in_2819_9153/payment</td>
                                                    <!--end::Status=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-end min-w-200px">10 Mar 2022,
                                                        2:40 pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Status=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-end min-w-200px">22 Sep 2022,
                                                        11:30 am</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Badge=-->
                                                    <!--begin::Status=-->
                                                    <td>POST /v1/invoice/in_4991_1223/invalid</td>
                                                    <!--end::Status=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-end min-w-200px">10 Nov 2022,
                                                        5:30 pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Badge=-->
                                                    <!--begin::Status=-->
                                                    <td>POST /v1/invoice/in_2719_7079/invalid</td>
                                                    <!--end::Status=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-end min-w-200px">25 Jul 2022,
                                                        10:30 am</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Status=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-end min-w-200px">05 May 2022,
                                                        10:30 am</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Badge=-->
                                                    <!--begin::Status=-->
                                                    <td>POST /v1/invoices/in_3712_2236/payment</td>
                                                    <!--end::Status=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-end min-w-200px">19 Aug 2022,
                                                        9:23 pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Badge=-->
                                                    <!--begin::Status=-->
                                                    <td>POST /v1/customer/c_61fa6e33cc5d5/not_found</td>
                                                    <!--end::Status=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-end min-w-200px">25 Jul 2022,
                                                        6:43 am</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Badge=-->
                                                    <!--begin::Status=-->
                                                    <td>POST /v1/invoices/in_6551_9145/payment</td>
                                                    <!--end::Status=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-end min-w-200px">20 Dec 2022,
                                                        10:10 pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">25
                                                    Jul 2022, 8:43 pm</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">05
                                                    May 2022, 11:30 am</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            <!--begin::Table row-->
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">20
                                                    Dec 2022, 9:23 pm</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">10
                                                    Nov 2022, 10:30 am</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            <!--begin::Table row-->
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">22
                                                    Sep 2022, 11:30 am</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            <!--begin::Table row-->
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">21
                                                    Feb 2022, 11:05 am</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            <!--begin::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">15
                                                    Apr 2022, 11:05 am</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                        </tbody>
                        ...
                        <div class="tab-pane fade" id="kt_customer_view_overview_statements" role="tabpanel">
                            ...
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <!--begin::Body-->
                                <div class="card-body py-0">
                                    <div class="fs-5 fw-bold text-gray-500 mb-4">Last 30 day earnings
                                            ...
                                            <div
                                                ...
                                                <span class="fs-1 fw-bolder text-gray-800 lh-1">
                                                    <span data-kt-countup="true" data-kt-countup-value="6,840"
                                                        data-kt-countup-prefix="$" class="counted">$6,840</span>
                                                ...
                                                <span class="fs-6 fw-bold text-muted d-block lh-1 pt-2">Net
                                                    Earnings</span>
                                            </div>
                                            <!--end::Col-->
                                            <!--begin::Col-->
                                            <div
                                                ...
                                                <span class="fs-1 fw-bolder text-gray-800 lh-1">
                                                    <span class="counted" data-kt-countup="true"
                                                        data-kt-countup-value="16">16</span>%
                                            ...
                                            <div
                                                ...
                                                <span class="fs-1 fw-bolder text-gray-800 lh-1">
                                                    <span data-kt-countup="true" data-kt-countup-value="1,240"
                                                        data-kt-countup-prefix="$" class="counted">$1,240</span>
                                                ...
                                                <div class="table-responsive">
                                                    <table id="kt_customer_view_statement_table_1"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2021-01-01T00:00:00+06:00">Nov 01, 2021
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">102445788</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2021-01-24T00:00:00+06:00">Oct 24, 2021
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">423445721</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2021-01-08T00:00:00+06:00">Oct 08, 2021
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">312445984</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2021-01-15T00:00:00+06:00">Sep 15, 2021
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">312445984</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2021-01-30T00:00:00+06:00">May 30, 2021
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">523445943</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2021-01-22T00:00:00+06:00">Apr 22, 2021
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">231445943</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2021-01-09T00:00:00+06:00">Feb 09, 2021
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">426445943</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2021-01-04T00:00:00+06:00">Jan 04, 2021
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">324442313</a>
                                                ...
                                                <div class="table-responsive">
                                                    <table id="kt_customer_view_statement_table_2"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2020-01-30T00:00:00+06:00">May 30, 2020
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">523445943</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2020-01-22T00:00:00+06:00">Apr 22, 2020
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">231445943</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2020-01-09T00:00:00+06:00">Feb 09, 2020
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">426445943</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2020-01-01T00:00:00+06:00">Nov 01, 2020
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">984445943</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2020-01-04T00:00:00+06:00">Jan 04, 2020
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">324442313</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2020-01-24T00:00:00+06:00">Oct 24, 2020
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">423445721</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2020-01-08T00:00:00+06:00">Oct 08, 2020
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">312445984</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2020-01-15T00:00:00+06:00">Sep 15, 2020
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">312445984</a>
                                                ...
                                                <div class="table-responsive">
                                                    <table id="kt_customer_view_statement_table_3"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2019-01-09T00:00:00+06:00">Feb 09, 2019
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">426445943</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2019-01-01T00:00:00+06:00">Nov 01, 2019
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">984445943</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2019-01-04T00:00:00+06:00">Jan 04, 2019
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">324442313</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2019-01-15T00:00:00+06:00">Sep 15, 2019
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">312445984</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2019-01-24T00:00:00+06:00">Oct 24, 2019
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">423445721</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2019-01-08T00:00:00+06:00">Oct 08, 2019
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">312445984</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2019-01-30T00:00:00+06:00">May 30, 2019
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">523445943</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2019-01-22T00:00:00+06:00">Apr 22, 2019
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">231445943</a>
                                                ...
                                                <div class="table-responsive">
                                                    <table id="kt_customer_view_statement_table_4"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2018-01-01T00:00:00+06:00">Nov 01, 2018
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">102445788</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2018-01-24T00:00:00+06:00">Oct 24, 2018
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">423445721</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2018-01-09T00:00:00+06:00">Feb 09, 2018
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">426445943</a>
                                                            ...
                                                            <tr class="odd">
                                                                <td data-order="2018-01-04T00:00:00+06:00">Jan 04, 2018
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">324442313</a>
                                                            ...
                                                            <tr class="even">
                                                                <td data-order="2018-01-08T00:00:00+06:00">Oct 08, 2018
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        class="text-gray-600 text-hover-primary">312445984</a>
                            ...
                            <form id="kt_modal_add_payment_form"
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <label class="fs-6 fw-bold form-label mb-2">
                                        ...
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                            title="" data-bs-original-title="The invoice number must be unique."
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                        ...
                                        data-hide-search="true" data-select2-id="select2-data-10-qf5j" tabindex="-1"
                                        aria-hidden="true">
                                        <option data-select2-id="select2-data-12-gca7"></option>
                                        ...
                                        dir="ltr" data-select2-id="select2-data-11-89b4" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-status-b6-container"
                                                aria-controls="select2-status-b6-container"><span
                                                    class="select2-selection__rendered"
                                                    id="select2-status-b6-container" role="textbox" aria-readonly="true"
                                                    title="Select an option"><span
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-bold form-label mb-2">Invoice
                                        Amount</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                            ...
                            <form id="kt_modal_adjust_balance_form"
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <select class="form-select form-select-solid fw-bolder select2-hidden-accessible"
                                        ...
                                        data-select2-id="select2-data-13-u9gs" tabindex="-1" aria-hidden="true">
                                        <option data-select2-id="select2-data-15-fnu1"></option>
                                        <option value="1">Credit</option>
                                        <option value="2">Debit</option>
                                    </select><span class="select2 select2-container select2-container--bootstrap5"
                                        dir="ltr" data-select2-id="select2-data-14-2iww" style="width: 100%;"><span
                                            class="selection"><span
                                                class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                aria-disabled="false" aria-labelledby="select2-adjustment-r7-container"
                                                aria-controls="select2-adjustment-r7-container"><span
                                                    class="select2-selection__rendered"
                                                    id="select2-adjustment-r7-container" role="textbox"
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-bold form-label mb-2">Add adjustment
                                        note</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                ...
                                <div class="fs-7 text-muted mb-15">Please be aware that all manual
                                    ...
                                    fortnight. Please maintain your invoices and receipts until then.
                                    Thank you.</div>
                                <!--end::Disclaimer-->
                                <!--begin::Actions-->
                                <div class="text-center">
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <div class="fw-bold">
                                                <div class="fs-6 text-gray-700">Updating customer
                                                    details will receive a privacy audit. For more info,
                                                    please read our
                                    ...
                                    <div id="kt_modal_update_customer_billing_info" class="collapse">
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <select name="country" aria-label="Select a Country" data-control="select2"
                                                ...
                                                data-select2-id="select2-data-16-l9bf" tabindex="-1" aria-hidden="true">
                                                <option value="" data-select2-id="select2-data-18-gbbf">Select a
                                                    Country...</option>
                                                ...
                                                dir="ltr" data-select2-id="select2-data-17-v634"
                                                style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single form-select form-select-solid fw-bolder"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-country-cy-container"
                                                        aria-controls="select2-country-cy-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-country-cy-container" role="textbox"
                                        ...
                                        <div class="row fv-row fv-plugins-icon-container">
                                            ...
                                            <div class="col-6">
                                                <select name="card_expiry_month"
                                                    ...
                                                    data-placeholder="Month" data-select2-id="select2-data-19-7m0h"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option data-select2-id="select2-data-21-c269"></option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap5"
                                                    dir="ltr" data-select2-id="select2-data-20-8tnl"
                                                    style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single form-select form-select-solid"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-card_expiry_month-i7-container"
                                                            aria-controls="select2-card_expiry_month-i7-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-card_expiry_month-i7-container"
                                            ...
                                            <div class="col-6">
                                                <select name="card_expiry_year"
                                                    class="form-select form-select-solid select2-hidden-accessible"
                                                    data-control="select2" data-hide-search="true"
                                                    data-placeholder="Year" data-select2-id="select2-data-22-vbtw"
                                                    tabindex="-1" aria-hidden="true">
                                                    <option data-select2-id="select2-data-24-a2kl"></option>
                                                    ...
                                                    class="select2 select2-container select2-container--bootstrap5"
                                                    dir="ltr" data-select2-id="select2-data-23-yrai"
                                                    style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single form-select form-select-solid"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            aria-labelledby="select2-card_expiry_year-4q-container"
                                                            aria-controls="select2-card_expiry_year-4q-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-card_expiry_year-4q-container"
